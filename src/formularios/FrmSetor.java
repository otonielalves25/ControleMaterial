...
public class FrmSetor extends javax.swing.JFrame {
    ...
    private void carregaGrelha() {
        ...
        List<Setor> lista = setorDao.getListagemOrdenado();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Nome Localidade:");
        ...
        grelha.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CÓDIGO", "NOME DA LOCALIDADE", "TIPO"
            }
        ) {
        ...
        lblTitulo.setText("Cadastro de Localidades");
        lblTitulo.setToolTipText("Cadastro de Unidade de Medida");
        lblTitulo.setOpaque(true);

        cboTipoLocalidade.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione...", "CIRETRAN", "POSTO DE TRÂNSITO", "COORDENADORIA", "SETOR", "OUTRO" }));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txtTexto, javax.swing.GroupLayout.PREFERRED_SIZE, 523, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(11, 11, 11)))
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(cboTipoLocalidade, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 234, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        if (this.txtCodigo.getText().equals("")) {
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                ...
                // unidadeDao.excluir(UnidadeMedida.class, Integer.parseInt(txtCodigo.getText()));
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (ValidarCampos.validarCampo(txtTexto, "nome localidade")) {
            return;
        }
        
        if (ValidarCampos.validarCampo(cboTipoLocalidade, "localidade")) {
            return;
        }

        //  Fim - Validando os campos obrigatórios
        Setor setor = new Setor();
        setor.setNomeSetor(txtTexto.getText().toUpperCase());
        setor.setTipoSetor(cboTipoLocalidade.getSelectedItem().toString());
    ...
    private void grelhaMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_grelhaMouseReleased
        ...
        try {
            if (grelha.getRowCount() > 0) {
                ...
                cboTipoLocalidade.setSelectedItem((String) grelha.getValueAt(grelha.getSelectedRow(), 2));
