 ...
 */
public class FrmUnidadeMedida extends javax.swing.JFrame {
    ...
    private void carregaGrelha() {
        ...
        List<UnidadeMedida> lista = unidadeDao.getListagemOrdenado();
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Cadastro de Unidade de Medida");
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (ValidarCampos.validarCampo(txtTexto, "unidade")) {
            return;
        }

        //  Fim - Validando os campos obrigatórios
        UnidadeMedida unidade = new UnidadeMedida();
        unidade.setNomeUnidade(txtTexto.getText().toUpperCase());
        ...
        if (novo) {
            ...
            unidade.setIdUnidade(Integer.parseInt(txtCodigo.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmUnidadeMedida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
