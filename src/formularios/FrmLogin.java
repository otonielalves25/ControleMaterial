...
public class FrmLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Password.png"))); // NOI18N

        lblDesejada.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        lblDesejada.setForeground(new java.awt.Color(0, 51, 102));
        lblDesejada.setText("Acesso Sistema Material");
        ...
        btnCancelar.setPreferredSize(new java.awt.Dimension(91, 33));
        ...
        jLabel4.setText("Versão 1.0.0 - 14/06/2022 - Coogi - Detran - PR");
    ...
    private void entrarSistema() {
        ...
        Usuario usuarioRetorno = usuarioDao.autenticarUsuario(login, senha);

        if (login.equals("admin") && senha.equals("admin")) {

            // SE FOR USUARIO DETRAN TAMBEM ENTRAN ////////////////////////////
            FrmPrincipal principal = new FrmPrincipal();
            Usuario usuario = new Usuario(null, "admin", "admin", "admin", true, 1, "");
            ...
            Session.setUsuario(usuarioRetorno);
