 ...
 * @author Tony
 */
public class FrmProdutoConsultaRapida extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public FrmProdutoConsultaRapida(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void carregaPesquisa() {
        ...
        List<Produto> listagem = produtoDao.getListagemOrdenadoLike(pesquisa);
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Consulta Rápida de Produto");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmProdutoConsultaRapida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmProdutoConsultaRapida dialog = new FrmProdutoConsultaRapida(new javax.swing.JFrame(), true);
